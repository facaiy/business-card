...
\newlength{\logowidth}  \setlength{\logowidth}{0.4in}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \matrix [below=\seplinedistance of hl1,%
        ...
        \node{\faGithub}; &\node{\href{https://github.com/facaiy}{\small facaiy}}; \\
        \node{\faFeed}; & \node{\href{https://facaiy.github.io/}{\small facaiy.github.io}};\\
        \node{\faLinkedin}; &\node{\href{https://www.linkedin.com/in/facaiy}{\small linkedin.com/in/facaiy}}; \\
        \node{\faEnvelope}; & \node{\href{mailto:facai.yan@gmail.com}{\small facai.yan@gmail.com}};\\
        \node{\faPhone}; & \node{\small 100 1000 1000};\\
        % \node{\faGraduationCap}; &\node{\small 上海交通大学}; \\
      };
      % sep line 2
      ...
      \matrix [below=\seplinedistance of hl2,
        ...
        \node{\faMars}; &
        %% TODO: logo颜色和其他图标不一致
        % \node{\includegraphics[width=\logowidth]{./figures/alibaba}}; &
        % \node{\faWeibo}; &
        \node{\faLaptop}; &
        \node{\faCameraRetro}; &
        \node{\faBook}; & \\
